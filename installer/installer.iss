...
; ============================================================
; ADICIONAR O ÍCONE DO INSTALADOR AQUI:
; ============================================================
...
OutputBaseFilename=Gerenciador_Horas
...
[Files]
Source: "D:\APP\Backup antigo\gerenciador_horas\build\windows\x64\runner\Release\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:\APP\Backup antigo\gerenciador_horas\build\windows\x64\runner\Release\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
; NOTE: Don't use "Flags: ignoreversion" on any shared system files.

[Icons]
; Adicionado o parâmetro IconFilename para garantir que o atalho use o ícone correto do executável instalado
