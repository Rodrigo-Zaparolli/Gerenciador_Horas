...
class _TarefasScreenState extends State<TarefasScreen> {
  ...
  void _testarEdesk(List<TimeLog> logsDoDia) {
    debugPrint('');
    debugPrint('====================================================');
    debugPrint('             TESTE DE INTEGRAÇÃO E-DESK');
    debugPrint('====================================================');
    debugPrint('Quantidade de registros: ${logsDoDia.length}');
    debugPrint('');

    for (var i = 0; i < logsDoDia.length; i++) {
      final log = logsDoDia[i];

      debugPrint('---------------- REGISTRO ${i + 1} ----------------');
      debugPrint('ID: ${log.id}');
      debugPrint('Projeto: ${log.projectName}');
      debugPrint('Tarefa: ${log.taskName}');
      debugPrint('Descrição: ${log.description}');
      debugPrint('Data: ${_formatShortDate(log.date)}');
      debugPrint('Início: ${log.startTime}');
      debugPrint('Fim: ${log.endTime}');
      debugPrint('Duração: ${log.durationFormatted}');
      debugPrint('Tipo: ${log.typeHs}');
      debugPrint('Target ID: ${log.targetId}');
      debugPrint('');
    }

    debugPrint('====================================================');
    debugPrint('              FIM DO TESTE E-DESK');
    debugPrint('====================================================');
    debugPrint('');
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          'Teste executado. ${logsDoDia.length} registro(s) enviado(s) ao console.',
        ),
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed:
                      logsDoDia.isEmpty ? null : () => _testarEdesk(logsDoDia),
                  child: const Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
